    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-6 w-full pb-[56px]">
        <div className="grid grid-cols-2 gap-6 items-center">
          ...
          <p className="font-['Inter',sans-serif] text-[16px] text-white font-regular">Padding is the internal spacing in components that separates content from external boundaries.</p>
        </div>
      </div>
