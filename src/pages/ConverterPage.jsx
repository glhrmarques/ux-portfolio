  ...
  return (
    <main className="flex-1 min-w-0 flex flex-col px-6 py-12 md:px-10 md:py-16 lg:px-16 lg:py-[120px]">
      ...
      <section className="flex flex-col gap-6 mb-20">
        <BackArrow />
        <h1 className="font-['Poppins',sans-serif] text-[32px] md:text-[44px] font-medium leading-[1.2] text-black">Building a currency tracker for travel expenses</h1>
        <div className="flex flex-wrap gap-2">
          <span className="px-4 py-1.5 rounded-full border border-[#d9d9d9] text-[14px] font-medium text-black font-['Poppins',sans-serif]">Figma</span>
          <span className="px-4 py-1.5 rounded-full border border-[#d9d9d9] text-[14px] font-medium text-black font-['Poppins',sans-serif]">Cursor</span>
          <span className="px-4 py-1.5 rounded-full border border-[#d9d9d9] text-[14px] font-medium text-black font-['Poppins',sans-serif]">Claude Opus 4.6</span>
        </div>
      ...
      {/* Application */}
      <section className="flex flex-col gap-6 mb-20">
        <h2 className="font-['Poppins',sans-serif] text-[24px] font-medium leading-[1.2] text-black">Aplication</h2>
      ...
      {/* Backend */}
      <section className="flex flex-col gap-6 mb-20">
        <h2 className="font-['Poppins',sans-serif] text-[24px] font-medium leading-[1.2] text-black">Backend</h2>
      ...
      {/* Frontend + AI */}
      <section className="flex flex-col gap-6 mb-20">
        <h2 className="font-['Poppins',sans-serif] text-[24px] font-medium leading-[1.2] text-black">Frontend + IA</h2>
      ...
      {/* Conclusion */}
      <section className="flex flex-col gap-6 mb-20">
        <h2 className="font-['Poppins',sans-serif] text-[24px] font-medium leading-[1.2] text-black">Conclusion</h2>
