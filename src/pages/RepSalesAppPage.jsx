    ...
    >
      ...
      <section className="flex flex-col gap-14 mb-[160px]">
        ...
        <div className="grid grid-cols-2 gap-[80px] gap-x-10 items-end ">
          <div className="w-full h-[464px] overflow-hidden bg-[#F4EAE2]">
            ...
            <div className="flex flex-col gap-2">
              <p className="font-['Figtree',sans-serif] text-[16px] md:text-[24px] font-medium text-black">Customer context</p>
            ...
            <div className="flex flex-col gap-2">
              <p className="font-['Figtree',sans-serif] text-[16px] md:text-[24px] font-medium text-black">Catalog browser</p>
              <p className="font-['Figtree',sans-serif] text-[18px] font-medium text-[#8C8C8C]">Going wide in ideation and rapidly testing concepts with users.</p>
            </div>
            ...
            <div className="flex flex-col gap-2">
              <p className="font-['Figtree',sans-serif] text-[16px] md:text-[24px] font-medium text-black">Product selection</p>
              <p className="font-['Figtree',sans-serif] text-[18px] font-medium text-[#8C8C8C]">Going wide in ideation and rapidly testing concepts with users.</p>
            </div>
            ...
            <div className="flex flex-col gap-2">
              <p className="font-['Figtree',sans-serif] text-[16px] md:text-[24px] font-medium text-black">Order creation</p>
              <p className="font-['Figtree',sans-serif] text-[18px] font-medium text-[#8C8C8C]">Going wide in ideation and rapidly testing concepts with users.</p>
            </div>
        </div>
      ...
      <section className="flex flex-col gap-14 mb-[160px]">
        ...
        <div className="grid grid-cols-1 gap-[24px]">
          <div class="flex flex-col gap-4">
            <h2 className="font-['Figtree',sans-serif] text-[44px] md:text-[22px] font-medium text-[black]">Prioritize speed over exploration</h2>
          ...
          <div className="grid grid-cols-2 gap-[24px]">
            <div className="w-full h-[280px] overflow-hidden bg-[#F4EAE2]">
              <img
                src="/images/sales-app-decision-2.png"
                alt="getting feedback with sales reps"
                className="w-full h-[400px] object-contain"
              />
            </div>
